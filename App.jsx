...
const EVENTS = [
  { id: 1, title: "FREE safeTALK Workshop", date: "2026-03-11", location: "Victoria, BC", organizer: "CMHA BC — Victoria Office", description: "Learn to recognize signs that someone may be thinking about suicide and how to connect them to life-saving help. Free, half-day training open to everyone.", link: "https://victoria.cmha.bc.ca/events/", free: true, regions: ["capital", "all"], type: "workshop" },
  { id: 2, title: "Psychological Health & Safety Navigator Training", date: "2026-03-16", location: "Online (BC-wide)", organizer: "CMHA BC Division", description: "Learn how to identify psychological hazards in the workplace and promote mental health and safety for employees. Multi-day certification program.", link: "https://bc.cmha.ca/events/", free: false, regions: ["all"], type: "training" },
  { id: 3, title: "Foundry Virtual — Weekly Mindfulness Drop-In", date: "2026-03-12", endDate: "2026-05-06", recurring: "Every Wednesday", location: "Online", organizer: "Foundry Virtual BC", description: "Weekly drop-in mindfulness sessions for youth ages 12–24. Guided meditations, breathing exercises, and mindful movement to manage stress.", link: "https://foundrybc.ca/virtual/groups-workshops/", free: true, regions: ["all"], type: "drop-in" },
  { id: 4, title: "Foundry Virtual — Queer Café", date: "2026-03-14", endDate: "2026-05-06", recurring: "Bi-weekly", location: "Online", organizer: "Foundry Virtual BC", description: "Virtual social group for youth who identify as 2SLGBTQ+ or are questioning. Activities, crafts, workshops, games, and connection in a safe space.", link: "https://foundrybc.ca/virtual/groups-workshops/", free: true, regions: ["all"], type: "drop-in" },
  { id: 5, title: "Foundry PG — Identity Collage Workshop Series", date: "2026-03-12", endDate: "2026-03-26", recurring: "Wednesdays in March", location: "Prince George, BC", organizer: "Foundry Prince George", description: "Create a collage that declares 'This is me!' — weaving together identity, passions, emotions, and life stories in a creative, supportive space for youth.", link: "https://foundrybc.ca/centre/princegeorge/", free: true, regions: ["fraser-fort-george", "all"], type: "workshop" },
  { id: 6, title: "Foundry PG — Life Skills & Career Readiness (12-week)", date: "2026-03-12", endDate: "2026-06-11", recurring: "Thursdays, 6–8 PM", location: "Prince George, BC", organizer: "Foundry Prince George", description: "Build confidence in communication, teamwork, and problem-solving. Identify and develop transferable skills for career and life success. Ages 12–24.", link: "https://foundrybc.ca/centre/princegeorge/", free: true, regions: ["fraser-fort-george", "all"], type: "program" },
  { id: 7, title: "Sandplay Therapy — Mother Archetype & the Feminine", date: "2026-03-21", endDate: "2026-03-23", location: "Vancouver Island, BC", organizer: "Canadian Assoc. for Sandplay Therapy", description: "In-person three-day training exploring the Mother archetype within the psyche, attachment theory, and the healing process through Sandplay Therapy.", link: "https://www.ccpa-accp.ca/general-continuing-education/events-calendar/", free: false, regions: ["capital", "nanaimo", "all"], type: "training" },
  { id: 8, title: "CMHA Living Life to the Full", date: "2026-03-24", recurring: "Weekly sessions", endDate: "2026-04-28", location: "Various BC locations & online", organizer: "CMHA BC", description: "Fun, interactive course designed to help people feel more in control of their mental health. Learn practical life skills based on CBT principles.", link: "https://bc.cmha.ca/events/", free: true, regions: ["all"], type: "program" },
  { id: 9, title: "ASIST Workshop (Applied Suicide Intervention Skills)", date: "2026-04-10", endDate: "2026-04-11", location: "Victoria, BC", organizer: "CMHA BC — Victoria Office", description: "Two-day intensive workshop for anyone 16 or older who wants to learn suicide first-aid intervention skills. Proven by major studies to save lives.", link: "https://victoria.cmha.bc.ca/events/", free: false, regions: ["capital", "all"], type: "workshop" },
  { id: 10, title: "BCACC Regional Roadshow — Kelowna", date: "2026-04-03", endDate: "2026-04-04", location: "Kelowna, BC", organizer: "BC Association of Clinical Counsellors", description: "Two-day gathering for mental health professionals featuring clinical workshops, stakeholder roundtables, and region-specific sessions on strengthening relationships after adverse events.", link: "https://www.bcacc.ca", free: false, regions: ["central-okanagan", "all"], type: "conference" },
  { id: 11, title: "Giwiidosendamin Certificate — Decolonized Addictions & Suicide Practices", date: "2026-04-13", endDate: "2026-04-17", location: "Vancouver, BC", organizer: "CTR Institute / CCPA", description: "Five-day program weaving Indigenous and Western knowledge in a two-eyed seeing approach to addictions and suicide support. Co-facilitated by Indigenous and non-Indigenous trainers.", link: "https://www.ccpa-accp.ca/general-continuing-education/events-calendar/", free: false, regions: ["metro-vancouver", "all"], type: "training" },
  { id: 12, title: "Foundry Virtual — Body Image Group (5-week)", date: "2026-04-07", endDate: "2026-05-05", recurring: "Weekly", location: "Online", organizer: "Foundry Virtual BC", description: "Free 5-week group for youth exploring their relationship with their body, gaining tools to manage feelings around body image, diet culture, and weight stigma.", link: "https://foundrybc.ca/virtual/youth-groups", free: true, regions: ["all"], type: "program" },
  { id: 13, title: "Foundry Virtual — ADHD Caregivers Workshop", date: "2026-04-15", endDate: "2026-04-22", recurring: "Two sessions", location: "Online", organizer: "Foundry Virtual BC", description: "Two-session series for caregivers of youth with ADHD. Learn about brain science, practical daily strategies, and connect with other caregivers.", link: "https://foundrybc.ca/virtual/groups-workshops/", free: true, regions: ["all"], type: "workshop" },
  { id: 14, title: "Foundry Virtual Services Info Session", date: "2026-04-23", location: "Online (12–1 PM)", organizer: "Foundry BC", description: "Learn how youth aged 12–24 and caregivers can access free virtual mental health & wellness services across BC. Open to providers and caregivers.", link: "https://foundrybc.ca/virtual/youth-groups", free: true, regions: ["all"], type: "info" },
  { id: 15, title: "BCACC Regional Roadshow — Victoria", date: "2026-04-24", endDate: "2026-04-25", location: "Victoria, BC", organizer: "BC Association of Clinical Counsellors", description: "Two-day regional gathering with workshops on understanding the intersections of trauma, adverse events, and opioid harms in BC.", link: "https://www.bcacc.ca", free: false, regions: ["capital", "all"], type: "conference" },
  { id: 16, title: "CACBT Conference — CBT in the Real World", date: "2026-05-01", endDate: "2026-05-02", location: "UBC, Vancouver", organizer: "Canadian Assoc. of Cognitive and Behavioural Therapies", description: "Annual conference with leading CBT experts covering existential concerns, death anxiety, perfectionism, modern parenting, and innovations in trauma and depression treatment.", link: "https://cacbt-actcc.ca", free: false, regions: ["metro-vancouver", "all"], type: "conference" },
];
...
export default function BCMentalHealthResources() {
  ...
  const filteredEvents = EVENTS.filter(e => selectedRegion === "all" || e.regions.includes("all") || e.regions.includes(selectedRegion)).sort((a, b) => new Date(a.date) - new Date(b.date));
        ...
        {page === "events" && (
          <div style={{ animation: "fadeIn 0.3s ease" }}>
            <div style={{ textAlign: "center", marginBottom: 18 }}>
              ...
              <p style={{ fontFamily: fonts.body, fontSize: 12.5, color: "#64748B", margin: 0 }}>March – May 2026 · Workshops, training, support groups & more</p>
            </div>

            <div style={{ display: "flex", flexWrap: "wrap", gap: 8, marginBottom: 16, justifyContent: "center" }}>
              {[{ type: "workshop", label: "Workshop", c: "#2E86AB" }, { type: "training", label: "Training", c: "#7E57C2" }, { type: "drop-in", label: "Drop-in", c: "#3A9E6E" }, { type: "program", label: "Program", c: "#E67E22" }, { type: "conference", label: "Conference", c: "#D94F4F" }, { type: "info", label: "Info Session", c: "#3498DB" }].map(t => (
            ...
            {filteredEvents.length === 0 ? (
              <div style={{ textAlign: "center", padding: "36px 18px", background: "#FFF", borderRadius: 16 }}>
                <div style={{ fontSize: 34, marginBottom: 10 }}>📅</div>
                <p style={{ fontFamily: fonts.heading, fontSize: 16, color: "#1E293B", margin: "0 0 5px 0" }}>No events for this region</p>
                <p style={{ fontFamily: fonts.body, fontSize: 12.5, color: "#94A3B8", margin: 0 }}>Select "All of British Columbia" to see all events</p>
              </div>
            ...
            <div style={{ marginTop: 18, padding: "14px 16px", background: "#FFF", borderRadius: 13, border: "1px solid #E2E8F0", textAlign: "center" }}>
              <p style={{ fontFamily: fonts.body, fontSize: 11.5, color: "#94A3B8", margin: "0 0 7px 0" }}>Find more events near you:</p>
